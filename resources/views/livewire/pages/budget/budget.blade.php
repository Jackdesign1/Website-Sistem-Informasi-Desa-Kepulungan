    ...
    <div class="flex-1">
        ...
        <div class="w-full border shadow-lg stats rounded-xl {{ $withChart? 'stats-vertical' : '' }}">
            <div class="stat">
                ...
                @endif
                <div class="stat-title">APBDes {{ $year }} Pembelanjaan</div>
                <div class="stat-value text-dark">Rp {{ number_format(0, 2) }}</div>
            ...
            <div class="stat">
                ...
                <div class="stat-value text-dark">Rp {{ number_format($operationalBudget, 2) }}</div>
                {{-- <div class="stat-desc">21% more than previous</div> --}}
            </div>
            <div class="stat">
                @if ($withChart)
                ...
                <div class="stat-value text-dark">Rp {{ number_format($villageBudget, 2) }}</div>
                {{-- <div class="stat-desc">21% more than previous</div> --}}
            </div>
        </div>
    </div>
