                    ...
                    <x-slot:content>
                        ...
                        <div class="mt-4 border-l ps-5">
                            ...
                            @foreach ($operationalType['details'] as $detailIndex => $detail)
                                <div class="flex flex-1 gap-3 px-3 pb-4 border-b md:border-b-0 md:pb-0 last:border-b-0" wire:key='{{ $typeIndex.$detailIndex }}'>
                                    ...
                                    <div class="flex items-end justify-center mt-3 md:mt-0">
                                        <x-mary-button
                                            class="btn-warning"
                                            icon="tabler.trash"
                                            wire:confirm="Apakah Anda yakin ingin menghapus detail operasional {{ $detail['operational_detail_name'] }}?"
                                            wire:click="operationalDetail('{{ $typeIndex }}', '{{ $detailIndex }}')"
