<div>
    <x-mary-header title="Tambah Acara" progress-indicator separator />
    ...
    <x-mary-form wire:submit='create' no-separator>
        ...
        <x-slot:actions>
            <x-mary-button label="Cancel" class="mt-5" icon="tabler.x" wire:click='$parent.createModalState = false; $wire.resetPage()' />
            <x-mary-button type="submit" label="Simpan" class="mt-5 btn-success" icon="tabler.check" spinner="create" />
        </x-slot:actions>
    </x-mary-form>
</div>
