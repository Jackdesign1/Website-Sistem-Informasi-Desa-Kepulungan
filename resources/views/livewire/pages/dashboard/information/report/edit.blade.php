        ...
        <x-mary-form wire:submit='edit' id="edit-news">
            <div class="flex-1 min-w-0 space-y-5">
                ...
                <div>
                    ...
                    <div class="flex flex-wrap min-w-0 gap-5 pt-2">
                        @foreach ($news->uploadedFileMedia as $media)
                            <div class="relative text-center min-w-32 max-w-32">
                                ...
                                <a href="{{ asset($media->url) }}" target="blank" class="text-sm link line-clamp-2 link-hover text-primary" title="{{ $media->name }}">{{ $media->name }}</a>
                            </div>
                        @endforeach
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="flex flex-wrap min-w-0 gap-5">
